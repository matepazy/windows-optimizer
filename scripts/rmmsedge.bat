...
write-host "`nRunning this script will remove Edge from your system."
write-host "`nWARNING: You won't be able to reinstall Edge after running this script"
$uconfirmation = Read-Host "`nContinue? [Y/N]"
if ($uconfirmation -ne "Y") { exit }
$host.ui.RawUI.WindowTitle = 'Edge Removal Script '
## targets
